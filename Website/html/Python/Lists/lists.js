...
loadCode("../../Python/Lists/Lists.py", 'codeDisplay1');
loadCode("../../Python/Lists/Working_with_Lists.py", 'codeDisplay2');
loadCode("../../Python/Lists/Python Gradebook.py", 'codeDisplay3');